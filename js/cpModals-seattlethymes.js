...
function testWrite() { document.write('<p>[ This is a test. If you are reading this, then cpModals.min.js has loaded. ]</p><p>&nbsp;</p>'); } 
		...
		<div class="modal-header"> <?php // start MODAL HEADER ?> 
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<div style="background-size: cover;">
					<img class="resize-logo-modal-header" src="http://glyder.com/poc/images/cp/modal-logo-seattlethymes.png">
