/* This js file will not work until all line breaks are removed from any function elements below. Complete code for each function must appear on only one line. */

/* MINIFIER will minify this js file in Sublime Text: Alt-Ctrl-Shift-M */

function testWrite() { document.write('<p>[ This is a test. If this text is shown, then the specific modal.min.js for this site has loaded. ]</p><p>&nbsp;</p>'); } 
...
<div class="modal fade" id="accessModal" tabindex="-1" role="dialog" aria-labelledby="accessModal" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		...
		<div class="modal-header"> <?php // start MODAL HEADER ?> 
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<div style="background-size: cover;">
					<img class="resize-logo-modal-header" src="http://glyder.com/test/image/logo/vendor/logo-kuow-sm.png">
					<img class="resize-logo-modal-header" src="http://glyder.com/test/image/modal/bullet.png">
					<img class="resize-logo-modal-header" src="http://glyder.com/test/image/modal/donate.png">
				</div>
		...
		<div class="modal-body"> <?php // start MODAL BODY ?> 
			...
			<div class="pod1-white podrr brdr brdr-all"> <?php // start pod2-white here ?> 
				<span class="text-pod-intro"><div>Would you like to contribute?</div></span>
			</div> <?php // end pod2-white ?> 

			<div class="pod0-2 podrf brdr brdr-l brdr-t brdr-r"> <?php // start pod0 here ?> 
				<span class="text-pod0"><div>One-click donation:</div></span>
			</div> <?php // end pod0-2 ?> 
				...
				<div id="access-container"> <?php // start div table container ?> 
					<div id="access-row"> <?php // start row 1 ?> 
						<div id="access-cell-1">
							<span class="vertical-align-middle"><div style="display:inline;">Support this&nbsp;</div><div style="display:inline;" id="div_item_type">[item_type]</div></span>
						</div> <?php // /cell-1 ?> 
				...
				<p class="access-row-sep"> </p> <?php // clear any floats above and separate table rows ?> 
					...
					<div id="access-row"> <?php // start row 2 ?> 
							<div class="item-info-tag">
								<div class="item-info-description" id="div_item_description">[item_description]</div><div style="display:inline;">: A 70-character description can go here here here here here.</div>
							</div> <?php // end item-info-tag div ?>
					</div> <?php // end row 2 ?>
			...
			<div class="pod1-white podfr brdr brdr-r brdr-b brdr-l"> 
					<div id="access-container"> <?php // start div table container ?> 
						...
						<div id="access-row-int"> <?php // start row 2 ?> 
							<div id="access-cell-1">
								<span class="vertical-align-middle">"Day&nbsp;Pass" Donation</span>
							</div> <?php // /cell-1 ?> 
							<div id="access-cell-2">
								<div>
									<button type="button" class="btn standard-button btn-primary" onclick="glyderBuyDaypassAndGo();""><div id="div_daypass_cost">$2.00</div></button>
								</div>
							</div> <?php // /cell-2 ?> 
						</div> <?php // /row 2 ?> 
					...
					<p class="access-row-sep"> </p> <?php // clear any floats above and separate table rows ?> 
						...
						<div id="access-row"> <?php // start row 3 ?> 
							<div id="access-cell-1">
								<span class="vertical-align-middle">One-Time Gift</span>
							</div> <?php // /cell-1 ?> 
							<div id="access-cell-2">
								<div>
					...
					<p class="access-row-sep"> </p> <?php // clear any floats above and separate table rows ?> 
						...
						<div id="access-row"> <?php // start row 3 ?> 
							<div id="access-cell-1">
								<span class="vertical-align-middle">Membership</span>
							</div> <?php // /cell-1 ?> 
							<div id="access-cell-2">
								<div>
									<button type="button" class="btn standard-button btn-primary btn-secondary">Options...</button>
				...
				<div class="pod2-white podrr brdr brdr-all"> <?php // start pod2 here ?> 
						...
						<div id="access-row">
							<div id="access-cell-1">
								<span class="vertical-align-middle">Not right now, thanks.</span>
							</div>
							<div id="access-cell-2">
								<button type="button" onclick="glyderBuyItemAndGo();" class="btn btn-primary standard-button close-button" data-dismiss="modal" aria-hidden="true" style="font-size: 1.2rem;">Close</button>
							</div>
						</div>
				...
				<div class="pod2-white podrr brdr brdr-all"> <?php // start pod2 THANK YOU RECEIPT here ?> 
					<div id="autopay-container">
						...
						<div id="access-row"> <?php // start row 1 ?> 
							<div id="access-cell-1-center">
								<div class="vertical-align-middle">
									<p><div id="div_access_message">Your prior support has made this content possible. Enjoy!</div></p>
								</div>
							</div> <?php // /cell-1 ?> 
						</div> <?php // /row 1 ?> 
